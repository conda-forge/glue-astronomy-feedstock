...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/glue-astronomy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10776&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/glue-astronomy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `glue-astronomy` can be installed with:

```
conda install glue-astronomy
```

It is possible to list all of the versions of `glue-astronomy` available on your platform with:
